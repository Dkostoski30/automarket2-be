...
CREATE TABLE IF NOT EXISTS inquiry_user_view (
    id    UUID PRIMARY KEY,
    email VARCHAR(255) NOT NULL,
    name  VARCHAR(100) NOT NULL
);

CREATE INDEX IF NOT EXISTS idx_inquiry_user_view_email ON inquiry_user_view(email);

INSERT INTO inquiry_user_view (id, email, name)
