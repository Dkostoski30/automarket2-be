package com.automarket.reference.service;
...
import com.automarket.reference.config.CacheConfig;
import com.automarket.reference.dto.ReferenceItemDto;
import com.automarket.reference.entity.CarBrand;
import com.automarket.reference.repository.*;
...
public class ReferenceService {
    ...
    public ReferenceItemDto createBrand(String name) {
        ...
        CarBrand brand = carBrandRepository.save(CarBrand.builder().name(name).build());
        log.info("Created car brand: {}", name);
    ...
    public void deleteBrand(UUID id) {
        if (!carBrandRepository.existsById(id)) {
            throw new ResourceNotFoundException("CarBrand", id);
        }
        carBrandRepository.deleteById(id);
        log.info("Deleted car brand: {}", id);
    }
    ...
    @Transactional(readOnly = true)
    public boolean validateBrandExists(UUID id) {
