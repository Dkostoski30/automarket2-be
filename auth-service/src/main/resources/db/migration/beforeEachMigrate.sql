...
-- tables — here `cities` and `listings` (auth V3, V4) — by unqualified name. They were written when every
...
-- `auth` alone (spring.datasource.hikari.schema), and Flyway restores the
...
SET search_path TO auth, listing;
