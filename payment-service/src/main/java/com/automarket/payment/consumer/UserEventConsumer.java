package com.automarket.payment.consumer;
...
/**
 * Keeps payment_user_view current from the user-events topic.
 *
...
public class UserEventConsumer {
    ...
    @KafkaListener(topics = KafkaTopics.USER_EVENTS, groupId = KafkaTopics.GROUP_PAYMENT)
    @Transactional
    ...
    private void upsert(JsonNode payload) {
        ...
        log.debug("Projected user {} into payment_user_view", userId);
    }
}
