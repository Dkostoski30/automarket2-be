...
CREATE TABLE IF NOT EXISTS payment_user_view (
    id    UUID PRIMARY KEY,
    email VARCHAR(255) NOT NULL,
    name  VARCHAR(100) NOT NULL
);

CREATE INDEX IF NOT EXISTS idx_payment_user_view_email ON payment_user_view(email);

INSERT INTO payment_user_view (id, email, name)
