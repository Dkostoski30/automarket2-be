...
-- tables — here `users` (payment V3) — by unqualified name. They were written when every
...
-- `payment` alone (spring.datasource.hikari.schema), and Flyway restores the
...
SET search_path TO payment, auth;
