...
-- tables — here `users` (blog V2) — by unqualified name. They were written when every
...
-- `blog` alone (spring.datasource.hikari.schema), and Flyway restores the
